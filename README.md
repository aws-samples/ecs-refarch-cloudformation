...
| [infrastructure/rds.yaml](infrastructure/product-service/service.yaml) | This is an example of how to deploy RDS postgres service on AWS.  We can do a Single or Multiple AZ deploy.|
|
